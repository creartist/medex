                ...
                @else
                                            ...
                                            @if (is_array($row->value))
                                                <div class="row">
                                                    @foreach ($row->value as $img)
                                                        <div class="col-3">
                                                            {!! Form::image(Storage::exists($img) ? Storage::url($img) : Storage::url('uploads/appLogo/78x78.png'), null, [
                    ...
                    @if (isset($form_value))
                        ...
                        <div class="form-actions pb-0 mt-3">
                            ...
                            {{ Form::submit(__('Submit'), ['id' => 'save-form', 'class' => 'btn btn-primary mr-1 float-end']) }}
                        </div>
                    @else
                        <div class="cap">
                            @if (setting('captcha') == 'hcaptcha')
