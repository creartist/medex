...
@section('content')
    <div class="row">
        {{ Form::model($poll, ['route' => ['fill.poll.store', $poll->id], 'data-validate', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
                    ...
                    <div class="form-group col-6 m-auto">
                        ...
                        <div class="mt-3 social-links-share">
                            ...
                            <a href="javascript:void(0)" title="Embed" class="social-links-share-main"
                                ...
                                data-url='<iframe src="{{ route('poll.survey', $id) }}" scrolling="auto" align="bottom" style="height:100vh;" width="100%"></iframe>'>
