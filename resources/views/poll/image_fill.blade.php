...
@section('content')
    <div class="row">
        {{ Form::model($poll, ['route' => ['image.poll.store', $poll->id], 'data-validate', 'method' => 'POST', 'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) }}
        <div class="row">
            <div class="col-xl-7 mx-auto order-xl-1">
                <div class="card">
                                                ...
                                                <div class="carousel-inner">
                                                    <div class="carousel-item active">
                                                        <img class="img-fluid d-block" height="200"
                                                            src="{{ Storage::exists($option->image) ? Storage::url($option->image) : Storage::url('uploads/appLogo/200x100.png') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        <div class="text-end">
                            {!! Form::submit(__('Vote'), ['class' => 'btn btn-primary col-md-3']) !!}
                    ...
                    <div class="form-group col-6 m-auto">
                        ...
                        <div class="mt-3 social-links-share">
                            ...
                            <a href="javascript:void(0)" title="Embed" class="social-links-share-main"
                                ...
                                data-url='<iframe src="{{ route('poll.survey.image', $id) }}" scrolling="auto" align="bottom" style="height:100vh;" width="100%"></iframe>'>
